...
| `dflash2` | Closed 2026-09-24: branch deleted | DFlash2 block-diffusion drafter port for Qwen3.8-27B (local 2-tap depthwise conv + candidate selector, `Qwen3.8-27B-DFlash2-Q4_K_M.gguf` in `models/`), 5 commits ahead of `master`. Paused at a measured ROCm checkpoint (2026-08-21): opt-in multi-scheduler reuse gives 29.59 aggregate / 36.90 decode / 785.58 prompt tok/s on 498+128 vs 29.00/36.33/749.70 for the single-cache control, with the strict n=3 boundary/parity gate bit-exact. DFlash was rejected (its draft path cost more VRAM than MTP at long context) and removed from the tree; the `dflash2` branch was deleted on 2026-09-24 and its work is archived in the bundle at `C:\GitHub-backups\dflash2-2026-09-24\dflash2-all.bundle`. History kept, see docs/local/CLEANUP_2026-09-24.md for the removal. |
