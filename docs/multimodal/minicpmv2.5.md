...
```bash
python /path/to/upstream-llama.cpp/tools/mtmd/legacy-models/minicpmv-surgery.py -m ../MiniCPM-Llama3-V-2_5
python /path/to/upstream-llama.cpp/tools/mtmd/legacy-models/minicpmv-convert-image-encoder-to-gguf.py -m ../MiniCPM-Llama3-V-2_5 --minicpmv-projector ../MiniCPM-Llama3-V-2_5/minicpmv.projector --output-dir ../MiniCPM-Llama3-V-2_5/ --minicpmv_version 2
python /path/to/upstream-llama.cpp/convert_hf_to_gguf.py ../MiniCPM-Llama3-V-2_5/model
