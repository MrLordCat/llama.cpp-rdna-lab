...
| T8a | Vulkan backend-host KV residency relief | D036 keeps a narrow Qwen35-like direct host-KV auto guard for default stability and restores decode to `40.2033 tok/s` (`1.9410 TPS` r3), while broad D034/D035 host-KV sweeps remain diagnostic and below D012 | reopen only with a lifetime/migration design that beats D012, not as a launch/KV placement sweep |
