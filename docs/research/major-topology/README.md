...
| ROCm FP8 program | [D098 native ROCm FP8 KV](D098_Q4KM_ROCM_FP8_KICKOFF.md), active on `master`: G1 byte-compatible HIP conversion passes 3/3; default-off G2 FP8-to-f16 reference FA passes Qwen D=256 prefill/decode 2/2; G3 gfx12 native FP8 rocWMMA is next. No speed/default claim before adjacent q8 gates. |
