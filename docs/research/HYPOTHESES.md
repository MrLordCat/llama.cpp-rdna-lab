...
13. H36 is confirmed as a practical repeated/steady route: keep server prompt cache/checkpoints enabled for GUI/agent sessions, but never compare it as a cold-first kernel speedup. After driver `32.0.31007.5012`, E113 supersedes E112's `24/48/64` ngram with `ngram-mod 12/16/32` (`17.8934 -> 19.5051 TPS`, after-first mean `23.9038 TPS`).
