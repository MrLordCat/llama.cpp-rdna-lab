...
- Kept profile change: H34 / E116+E118+E119+E120+E121, Q3_K_S ctx=12288 Vulkan q4 decode-heavy route; r3 decode gate was about `40 TPS`, real-context 512-token session r3 reached `32.1668 TPS` aggregate / `33.96 TPS` warm-only, and 256-token session r3 still beat ROCm by `+19.00%` aggregate. Live-server output sanity was accepted by the user. E117 keeps ROCm prompt-heavy default on q4 KV.
