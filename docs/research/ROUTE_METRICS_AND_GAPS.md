...
The current user focus is Vulkan 64k; its highest-share blockers are the active
large Q3_K prompt shader and q4 FlashAttention route, not speculative decode or
nearby launch flags.
