...
The current user focus is H39 ROCm decode parity against Vulkan. The active
short-decode blocker is the Q3_K MMVQ route; Vulkan 64k remains documented as a
separate paused lane whose highest-share blockers are large Q3_K prompt shader
work and q4 FlashAttention.
