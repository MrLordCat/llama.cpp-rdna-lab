...
typedef struct {
    ggml_half d;
    uint8_t qs[QKPQ2_0 / 4];
} block_pq2_0;
static_assert(sizeof(block_pq2_0) == sizeof(ggml_half) + QKPQ2_0 / 4, "wrong pq2_0 block size/padding");
...
static_assert(sizeof(block_q3_K_padded) == 112, "wrong padded q3_K block size/padding");
