...
static __global__ void flash_attn_ext_vec(
    ...
    constexpr bool K_is_tkv = type_K == GGML_TYPE_TKV2_0 || type_K == GGML_TYPE_TKV3_0 || type_K == GGML_TYPE_TKV4_0;
    constexpr bool K_uses_float_q = type_K == GGML_TYPE_F16 || type_K == GGML_TYPE_BF16 || K_is_tkv;
    constexpr bool V_uses_vec_dequant = type_V == GGML_TYPE_F16 || type_V == GGML_TYPE_BF16;
    constexpr int nthreads_KQ = K_uses_float_q ? 128 / cpy_nb : nthreads_KQ_q;
    constexpr int nthreads_V  = V_uses_vec_dequant ? 128 / cpy_nb : nthreads_V_q;

    static_assert(WARP_SIZE % nthreads_KQ == 0, "bad nthreads_K");
    static_assert(WARP_SIZE % nthreads_V  == 0, "bad nthreads_V");

    constexpr int V_rows_per_thread = V_uses_vec_dequant ? 2*cpy_ne : 4;
...
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TKV2_0, GGML_TYPE_TKV2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TKV3_0, GGML_TYPE_TKV3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TKV4_0, GGML_TYPE_TKV4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TKV2_0, GGML_TYPE_TKV2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TKV3_0, GGML_TYPE_TKV3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TKV4_0, GGML_TYPE_TKV4_0);
