...
ggml_backend_dev_t llama_memory_hybrid_iswa::get_layer_device(int32_t il) const {
...
const llama_ubatch * llama_memory_hybrid_iswa_context::peek_next_ubatch() const {
